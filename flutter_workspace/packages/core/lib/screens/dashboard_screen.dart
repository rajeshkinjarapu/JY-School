        ...
        Padding(
          ...
          child: GridView.count(
            ...
            children: [
              ...
              _buildGridItem(context, 'App Installs', Icons.install_mobile_rounded, const Color(0xFF673AB7), () => Navigator.push(context, MaterialPageRoute(builder: (_) => const Scaffold(body: Center(child: Text('Coming Soon')))))),
            ],
          ),
        ),
      ],
