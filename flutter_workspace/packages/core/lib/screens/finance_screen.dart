...
class _FinanceScreenState extends State<FinanceScreen> {
  ...
  Widget _buildModulesGrid() {
    final modules = [
      {'title': 'Pending', 'desc': 'Approvals', 'icon': Icons.pending_actions_rounded, 'color': const Color(0xFFEF4444), 'screen': const Scaffold(body: Center(child: Text('Coming Soon')))},      {'title': 'Collect Fee', 'desc': 'Search & Pay', 'icon': Icons.account_balance_wallet_rounded, 'color': const Color(0xFF10B981), 'screen': const StudentFeeSearchScreen()},
      ...
      {'title': 'Payment Setup', 'desc': 'Bank & QR Code', 'icon': Icons.qr_code_2_rounded, 'color': const Color(0xFF64748B), 'screen': const Scaffold(body: Center(child: Text('Coming Soon')))},      {'title': 'Fee Category', 'desc': 'Add Custom Fee', 'icon': Icons.category_rounded, 'color': const Color(0xFFEC4899), 'screen': const AddStudentFeeScreen()},
