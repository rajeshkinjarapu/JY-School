            ...
            child: Container(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text('Γ£ª', style: TextStyle(color: Color(0xFFD4A017), fontSize: 12)),
                    const SizedBox(width: 8),
                    Container(width: 40, height: 1.5, color: const Color(0xFFF39C12)),
                    const SizedBox(width: 8),
                    const Text('Γÿà', style: TextStyle(color: Color(0xFFD4A017), fontSize: 14)),
                    const SizedBox(width: 8),
                    Container(width: 40, height: 1.5, color: const Color(0xFFF39C12)),
                    const SizedBox(width: 8),
                    const Text('Γ£ª', style: TextStyle(color: Color(0xFFD4A017), fontSize: 12)),
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        children: [
                          _buildPremiumInfoRow('≡ƒæñ Student Name', name.toUpperCase(), isEven: false),
                          _buildPremiumInfoRow('≡ƒåö Student ID', rollNo.toString(), isEven: true),
                          _buildPremiumInfoRow('≡ƒôÜ Class', className, isEven: false),
                          _buildPremiumInfoRow('≡ƒôû Section', section, isEven: true),
                          _buildPremiumInfoRow('≡ƒô₧ Mobile', _resultData!['mobile']?.toString() ?? widget.studentData?['mobile']?.toString() ?? 'N/A', isEven: false),
                          _buildPremiumInfoRow('≡ƒôà Academic Year', '2026-2027', isEven: true),
                          _buildPremiumInfoRow('≡ƒôì Location', 'Narasannapeta', isEven: false, isLast: rank == null),
                          if (rank != null)
                            _buildPremiumInfoRow('≡ƒÅà Class Rank', '#' + rank, isEven: true, isLast: true),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: (photoUrl != null && photoUrl.toString().isNotEmpty)
                            ? ClipRRect(borderRadius: BorderRadius.circular(5), child: CustomNetworkImage(ApiService.getImageUrl(photoUrl.toString()), fit: BoxFit.cover, errorBuilder: (c, e, s) => _buildPhotoPlaceholder('≡ƒô╖', false)))
                            : _buildPhotoPlaceholder('≡ƒô╖', false),
                        ),
                      ),
                    ),
                  ],
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            const Text('≡ƒôè', style: TextStyle(fontSize: 22)),
                            const SizedBox(width: 12),
                        ...
                        child: Column(
                          children: [
                                ...
                                child: Row(
                                  children: [
                                    Expanded(flex: 3, child: Row(
                                      children: [
                                        const Text('≡ƒôÿ', style: TextStyle(fontSize: 14)),
                                        const SizedBox(width: 8),
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Expanded(flex: 3, child: Text('≡ƒôî TOTAL', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w900, color: const Color(0xFF0B1A33), letterSpacing: 1.0))),
                ...
                child: Row(
                  ...
                  children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('≡ƒôï Total Marks: $totalMarksObtainedStr / ${totalMaxMarks.toStringAsFixed(0)}', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w800, color: const Color(0xFF1A4A7A), letterSpacing: 0.5)),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text('Γ£ì Teacher Signature', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFF1A3A5A))),
                            ],
                          ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text('Γ£ì Principal Signature', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFF1A3A5A))),
                            ],
                          ),
                        ],
                      ),
              ...
              Container(
                ...
                child: Text(
                  'Γÿà This is a system-generated result card for ${widget.examName} Γÿà',
                  textAlign: TextAlign.center,
