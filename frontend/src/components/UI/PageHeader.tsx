...
export const PageHeader: React.FC<PageHeaderProps> = ({ title, icon, action }) => {
  return (
    <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900 px-3 py-3 sm:px-8 sm:py-3 shadow-md border-b border-indigo-900/50 shrink-0 print:hidden">
