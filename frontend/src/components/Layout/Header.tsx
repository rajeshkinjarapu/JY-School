...
export const Header: React.FC<HeaderProps> = ({ onMenuClick, title, forceShow, hideMenuButton }) => {
  ...
  return (
    <header
      className={`print:hidden lg:hidden sticky top-0 z-30 flex items-center justify-between gap-3 px-3 py-2.5 pt-[max(env(safe-area-inset-top),0.75rem)] shadow-lg shadow-black/30`}
