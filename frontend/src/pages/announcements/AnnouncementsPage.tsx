        ...
        action={
          isManagement ? (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 text-sm font-extrabold text-indigo-700 bg-white rounded-xl shadow hover:bg-indigo-50 transition-colors w-full md:w-auto cursor-pointer"
            >
