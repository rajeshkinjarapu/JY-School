...
import { Search, UserPlus, Trash2, Edit, Upload, FileDown, Eye } from "lucide-react";
            ...
            <table className="w-full text-sm text-left border-collapse">
              <thead>
                <tr className="bg-indigo-50/50 text-indigo-900 font-semibold border-b border-indigo-100">
                  <th className="px-6 py-4 font-extrabold text-xs uppercase tracking-wider text-gray-400">
                    Teacher
                  </th>
                  <th className="px-6 py-4 font-extrabold text-xs uppercase tracking-wider text-gray-400">
                    Employee ID
                  ...
                  <th className="px-6 py-4 font-extrabold text-xs uppercase tracking-wider text-gray-400 text-right">
                    Actions
                  </th>
                </tr>
              </thead>
                        ...
                        <div className="relative">
                          {getPhotoUrl(teacher.user?.photoUrl) ? (
                            <img
                              ...
                              alt={name}
                              className="w-12 h-12 rounded-2xl object-cover shadow-sm border border-gray-100 dark:border-white/10"
                            />
                          ) : (
                            <div
                              className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${colorClass} flex items-center justify-center text-white font-black text-lg shadow-sm border-2 border-white dark:border-white/10`}
                            >
                              {getInitials(name)}
                            </div>
                          )}
