...
- "FORMATIVE ASSESSMENT - 1" ఎగ్జామ్ క్రియేషన్‌లో ప్రతి తరగతికి (Class) సబ్జెక్టులు వేర్వేరుగా ఉన్నప్పటికీ, డేటాబేస్ నుండి ఆయా క్లాస్ సబ్జెక్ట్‌లను ఆటో-ఫెచ్ చేసి సబ్జెక్ట్-వైజ్ Max Marks కాన్ఫిగర్ చేసేలా Web Frontend, Backend API మరియు Flutter Mobile App 3 ప్రధాన భాగాలలో ఇంప్లిమెంటేషన్ విజయవంతంగా పూర్తయింది.
