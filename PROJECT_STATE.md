...
- **AI Paper Generator Formatting Options**: Added "Show Paper Header", "Show Page Border", "Text Size", and "Paragraph Height" controls in the Paper Settings for the AI Paper Generator, giving users complete control over the layout density and header/border visibility.
